...
* Thu May 28 2026 Wenlong Zhang <zhangwenlong@loongson.cn> - 3.3.0-31
- Type:requirement
- CVE:NA
- SUG:NA
- DESC: modify rpmlist.xml on loongarch64 for openEuler-24.03-LTS-SP4
...
- CVE:NA
- SUG:NA
- DESC:remove krun from aarch64

* Tue May 19 2026 hewanhan <hewanhan@h-partners.com> - 3.3.0-28
- Type:requirement
- CVE:NA
- SUG:NA
- DESC:add krun to aarch64

* Wed May 6 2026 zhaoyonghao <zhaoyonghao10@h-partners.com> - 3.3.0-27
- Type:requirement
- CVE:NA
- SUG:NA
- DESC:remove kernel-64k-headers for aarch64

* Thu Apr 30 2026 zhaoyonghao <zhaoyonghao10@h-partners.com> - 3.3.0-26
- Type:requirement
- CVE:NA
- SUG:NA
...
* Sat Dec 13 2025 xiexiunian <xiexiunian@h-partners.com> - 3.3.0-21
- ID:NA 
- SUG:NA
...
* Mon May 26 2025 Liu Wang <1823363429@qq.com> - 3.3.0-12
- ID:NA
- SUG:NA
- DESC: add euler-copilot-web server

* Wed May 07 2025 Liu Wang <1823363429@qq.com> - 3.3.0-11
- ID:NA
- SUG:NA
- DESC: add nodejs-packaging dependency

* Mon Apr 28 2025 Liu Wang <1823363429@qq.com> - 3.3.0-10
- ID:NA
- SUG:NA
- DESC: delete code software

* Fri Apr 25 2025 zhangjian <zhangjian496@huawei.com> - 3.3.0-9
-ID:NA
-SUG:NA
-DESC: use python3-file-magic instead of python3-magic

* Tue Apr 22 2025 Liu Wang <1823363429@qq.com> - 3.3.0-8
-ID:NA
-SUG:NA
-DESC: delete duplicate software packages
